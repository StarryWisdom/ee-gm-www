...
class _svg_helper {
	create_svg(width,height,viewport_x,viewport_y,viewport_width,viewport_height) {
	...
	create_png_image(x,y,width,height,data_url) {
...
const svg_helper = new _svg_helper()