...
add_function("start1",function ()
	getScriptStorage()._cuf_gm["rift_example"](41023, 365191,7000,60,"base1")
	getScriptStorage()._cuf_gm["rift_example"](44382, 359059,7000,60)
	getScriptStorage()._cuf_gm["rift_example"](48041, 364988,7000,60)
	getScriptStorage()._cuf_gm["rift_example"](45067, 372934,4000,60)
	getScriptStorage()._cuf_gm["rift_example"](53032, 357862,4000,60)
	getScriptStorage()._cuf_gm["rift_example"](36259, 358047,4000,60)
end)
add_function("start2",function ()
	getScriptStorage()._cuf_gm["rift_example"](43071, 367398,7000,60,"base2")
	getScriptStorage()._cuf_gm["rift_example"](47202, 366427,7000,60)
	getScriptStorage()._cuf_gm["rift_example"](48427, 362364,7000,60)
	getScriptStorage()._cuf_gm["rift_example"](45521, 359272,7000,60)
	getScriptStorage()._cuf_gm["rift_example"](41390, 360243,7000,60)
	getScriptStorage()._cuf_gm["rift_example"](40165, 364306,7000,60)
end)
add_function("start3",function ()
getScriptStorage()._cuf_gm["rift_example"](33479, 353054,7000,90,"base3")
getScriptStorage()._cuf_gm["rift_example"](35633, 363809,7000,90)
getScriptStorage()._cuf_gm["rift_example"](43352, 371851,7000,90)
getScriptStorage()._cuf_gm["rift_example"](43663, 348382,7000,90)
getScriptStorage()._cuf_gm["rift_example"](52341, 365122,7000,90)
getScriptStorage()._cuf_gm["rift_example"](54199, 353741,7000,90)
getScriptStorage()._cuf_gm["rift_example"](43780, 355428,7000,90)
getScriptStorage()._cuf_gm["rift_example"](43843, 362397,7000,90)
end)
add_function("start4",function ()
getScriptStorage()._cuf_gm["rift_example"](43967, 352016,7000,90,"base4")
getScriptStorage()._cuf_gm["rift_example"](51377, 354478,7000,90)
getScriptStorage()._cuf_gm["rift_example"](36358, 354485,7000,90)
getScriptStorage()._cuf_gm["rift_example"](43719, 362112,7000,90)
getScriptStorage()._cuf_gm["rift_example"](53732, 361946,7000,90)
getScriptStorage()._cuf_gm["rift_example"](51316, 369529,7000,90)
getScriptStorage()._cuf_gm["rift_example"](43719, 371959,7000,90)
getScriptStorage()._cuf_gm["rift_example"](36327, 369458,7000,90)
getScriptStorage()._cuf_gm["rift_example"](33706, 362112,7000,90)

end)
add_function("start5",function ()
getScriptStorage()._cuf_gm["rift_example"](35158, 370882,10000,120,"base5")
getScriptStorage()._cuf_gm["rift_example"](43736, 379711,10000,120)
getScriptStorage()._cuf_gm["rift_example"](52655, 371014,10000,120)
getScriptStorage()._cuf_gm["rift_example"](61374, 362198,10000,120)
getScriptStorage()._cuf_gm["rift_example"](43865, 362200,10000,120)
getScriptStorage()._cuf_gm["rift_example"](26331, 362254,10000,120)
getScriptStorage()._cuf_gm["rift_example"](34997, 353254,10000,120)
getScriptStorage()._cuf_gm["rift_example"](43805, 344713,10000,120)
getScriptStorage()._cuf_gm["rift_example"](52673, 353298,10000,120)
end)